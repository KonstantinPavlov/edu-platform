...
public class NewsResourceIntTest {
    ...
    private static final String DEFAULT_NEWS_IMAGE = "AAAAAAAAAA";
    private static final String UPDATED_NEWS_IMAGE = "BBBBBBBBBB";
    ...
    public void createNews() throws Exception {
        ...
        assertThat(testNews.getNewsImage()).isEqualTo(DEFAULT_NEWS_IMAGE);
    ...
    public void getAllNews() throws Exception {
        ...
        restNewsMockMvc.perform(get("/api/news?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].newsImage").value(hasItem(DEFAULT_NEWS_IMAGE.toString())))
    ...
    public void getNews() throws Exception {
        ...
        restNewsMockMvc.perform(get("/api/news/{id}", news.getId()))
            ...
            .andExpect(jsonPath("$.newsImage").value(DEFAULT_NEWS_IMAGE.toString()))
    ...
    public void updateNews() throws Exception {
        ...
        assertThat(testNews.getNewsImage()).isEqualTo(UPDATED_NEWS_IMAGE);
