...
public class News implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<NewsComments> comments = new HashSet<>();
    ...
    public News newsImage(String newsImage) {
    ...
    public Set<NewsComments> getComments() {
        return comments;
    }

    public News comments(Set<NewsComments> newsComments) {
        this.comments = newsComments;
        return this;
    }

    public News addComments(NewsComments newsComments) {
        this.comments.add(newsComments);
        newsComments.setNews(this);
        return this;
    }

    public News removeComments(NewsComments newsComments) {
        this.comments.remove(newsComments);
        newsComments.setNews(null);
        return this;
    }

    public void setComments(Set<NewsComments> newsComments) {
        this.comments = newsComments;
    }
